            ...
            <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-5">
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex items-start gap-2">
                  ...
                  Good lighting helps detect more ingredients
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400" />
                  Include all visible ingredients in the frame
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-400" />
              ...
              <div className="space-y-5 rounded-3xl border border-slate-700/70 bg-slate-950/90 p-6 shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
                ...
                <div>
                  <h3 className="mb-3 text-xs font-semibold uppercase tracking-wider text-emerald-400">
                    🍽️ Generated Recipes ({scanResult.recipes?.length || 0})
                  </h3>
...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="rounded-2xl border border-slate-700/50 bg-slate-900/50 p-4 transition hover:border-slate-600">
  ...
  <div className="group rounded-2xl border border-slate-700/60 bg-slate-900/80 p-4 transition hover:border-emerald-500/40 hover:bg-slate-900">
    <div className="flex items-start justify-between gap-4">
      <div className="flex-1">
        <h4 className="font-semibold text-slate-100 transition group-hover:text-emerald-400">
          {recipe.title}
        </h4>
      ...
      <button
        onClick={onView}
        className="shrink-0 rounded-xl bg-[#FF7043] px-4 py-2 text-sm font-semibold text-white shadow-lg transition hover:scale-105 hover:bg-[#ff865f]"
      >
        View
      </button>
    </div>
